...
(function() {
  function init(e) {
    ...
    var versions = ['2.3.0', '2.3.1', '2.3.2', '2.3.3', '2.3.4', '2.3.5', '2.3.6'];
    ...
    function updateMapSelector() {
      ...
      if (localMaps.length == 0) {
        ...
        localMaps.forEach(function(map) {
          if (!optgroups[map.country]) {
            optgroups[map.country] = document.createElement('optgroup');
            optgroups[map.country].label = I18n.t('openmaps.countries.' + map.country);
          }
          var option = document.createElement('option');
          option.text = map.title;
          option.value = map.id;
          option.title = map.abstract;
          optgroups[map.country].appendChild(option);
        });
