          ...
          if (response.status == 200) {
            ...
            if (serviceException) {
              ...
              callback({
                ...
                description: I18n.t('openmpas.errors.see_console')
              })
            }
          } else {
            callback({
