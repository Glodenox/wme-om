  ...
  function init(e) {
    ...
    var om_strings = {
      en: {
        ...
        hideshow_layer: 'Hide/Show layer',
        query_window_title: 'Map Location Query',
        query_window_loading: 'Retrieving information from map service...',
        query_empty_response: 'No response received from map service. Perhaps try another layer?',
        ...
        edit_layer: 'Edit layer attributes',
        ...
        errors: {
          ...
          parse_fail: 'Could not parse error message, raw data shown below'
        },
        update: {
      ...
      nl: {
        ...
        hideshow_layer: 'Verberg/Toon laag',
        query_window_title: 'Kaartlocatie doorzoeken',
        query_window_loading: 'Informatie aan het opvragen bij kaartdienst...',
        query_empty_response: 'Geen antwoord ontvangen van de kaartdienst. Misschien kan je een andere laag proberen?',
        ...
        edit_layer: 'Pas de laageigenschappen aan',
        remove_layer: 'Verwijder laag',
        ...
        errors: {
          ...
          network_console: 'Bekijk de browserconsole voor meer informatie',
          timeout: 'Time-out',
          timeout_description: 'Antwoord verkrijgen duurde langer dan 10 seconden, waarschijnlijk netwerkprobleem',
          parse_fail: 'Kan foutmelding niet verwerken, de ruwe data wordt hieronder weergegeven'
        },
        update: {
          message: 'Nieuwe versie geïnstalleerd! Veranderingen:',
      ...
      'click': function(e) {
        ...
        GM_xmlhttpRequest({
          ...
          onerror: function(e) {
            ...
            queryWindowContent.appendChild(errorResponseTitle);
            var errorResponse = document.createElement('p');
            errorResponse.appendChild(document.createTextNode(I18n.t('openmaps.errors.network_console')));
            queryWindowContent.appendChild(errorResponse);
          }
        });
      }
        ...
        onload: function (response) {
          if (response.status == 200) {
            ...
            if (serviceException) {
              ...
              callback({
                title: I18n.t('openmpas.errors.parse_fail'),
    ...
    function MapHandle(map, options) {
      ...
      this.updateLayers = function() {
        ...
        if (visibleLayers && visibleLayers.length == 0 && this.layer) { // Hide map as it has no more layers
          ...
          this.layer.setVisibility(!this.outOfArea);
      ...
      remove.title = I18n.t('openmaps.remove_layer');
      $(remove).tooltip();
      ...
      edit.title = I18n.t('openmaps.edit_layer');
      $(edit).tooltip();
      ...
      visibility.title = I18n.t('openmaps.hideshow_layer');
      $(visibility).tooltip();
      ...
      if (map.queryable) {
        ...
        query.title = I18n.t('openmaps.query_layer');
        $(query).tooltip();
        ...
        query.addEventListener('click', function() {
          ...
          self.mapLayers.forEach(function(mapLayer) {
            if (map.layers[mapLayer.name].queryable) {
      ...
      self.mapLayers.forEach(function(layerItem) {
        ...
        var visibility = document.createElement('span');
        visibility.style.fontFamily = 'FontAwesome';
        visibility.style.margin = '0 3px';
        visibility.style.float = 'right';
        visibility.style.cursor = 'pointer';
        visibility.appendChild(document.createTextNode(''));
        ...
        if (mapLayer.queryable) {
          ...
          layerQuery.style.fontFamily = 'FontAwesome';
          layerQuery.style.margin = '0 3px';
          layerQuery.style.float = 'right';
          layerQuery.style.cursor = 'pointer';
          layerQuery.appendChild(document.createTextNode(''));
