...
function init(e) {
  ...
  var versions = ['2.3.0', '2.3.1', '2.3.2', '2.3.3', '2.3.4', '2.3.5', '2.3.6', '2.3.7', '2.3.8', '2.3.9', '2.3.10', '2.3.11', '2.4.0', '2.5.0', '2.5.1', '2.5.2', '2.6.0', '2.6.1', '2.6.2', '2.7.0', '2.7.1', '2.7.2', '2.7.3', '2.7.4', '2.7.5', '2.7.6', '2.7.7', '2.8.0', '2.8.1', '2.8.2', '2.8.3'];
  ...
  var maps = {
    ...
    '3213': { id: 3213, title: 'CRAB OGC', url: 'http://crab.agiv.be/OGC/Service.svc/', crs: 'EPSG:31370', bbox: new OL.Bounds(280525.11676, 6557859.253174342, 661237.77522, 6712007.501374752), format: 'image/png', area: 'BE', abstract: 'De Lite CRAB entiteiten met geometrische compenent (adres, gebouw, wegverbinding) worden in deze service ontsloten via standaard de OGC interfaces voor gebruik in bijvoorbeeld een GIS omgeving.', attribution: 'Agentschap Informatie Vlaanderen', queryable: true, query_filters: [ applyAllTransformations ], default_layers: [ 'adres', 'gebouw', 'wegverbinding', 'afwijking', 'gemeente', 'straatnaamlabel' ], layers: { 'adres': { queryable: true, title: 'Adresposities', abstract: 'Duidt de positie van een adres aan.' }, 'gebouw': { queryable: true, title: 'Gebouw', abstract: 'Gebouw opgemeten in het GRB of afkomstig van de gemeente.' }, 'wegverbinding': { queryable: true, title: 'Wegverbinding', abstract: 'Wegverbinding opgemeten in het GRB of afkomstig van de gemeente.' }, 'afwijking': { queryable: true, title: 'Afwijking', abstract: 'Afwijkingen gemeld door gebruikers.' }, 'gemeente': { queryable: true, title: 'Gemeentegrenzen' }, 'straatnaamlabel': { queryable: true, title: 'Straatnaamlabel', abstract: 'Labels van de straatnamen.' } } },
  ...
  // Remove 'Expert mode' April fools joke as it blocks the query window
  var expertMode = document.getElementById('expert-mode');
  if (expertMode && expertMode.remove) {
    expertMode.remove();
  }
