...
function init(e) {
  ...
  var versions = ['2.3.0', '2.3.1', '2.3.2', '2.3.3', '2.3.4', '2.3.5', '2.3.6', '2.3.7', '2.3.8', '2.3.9', '2.3.10', '2.3.11', '2.4.0', '2.5.0', '2.5.1', '2.5.2', '2.6.0', '2.6.1', '2.6.2', '2.7.0'];
  ...
  function MapHandle(map, options) {
    ...
    this.updateVisibility = function() {
      ...
      info.style.display = (self.layer && self.layer.getVisibility() ? 'block' : 'none');
