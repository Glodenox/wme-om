...
(function() {
  function init(e) {
    ...
    var versions = ['2.3.0', '2.3.1', '2.3.2', '2.3.3', '2.3.4', '2.3.5', '2.3.6', '2.3.7', '2.3.8', '2.3.9', '2.3.10', '2.3.11', '2.4.0'];
    ...
    function MapHandle(map, options) {
      ...
      var layerToggler = createLayerToggler(omGroup, !this.hidden, map.title, function(visible) {
        console.log(map.title + ' toggle clicked', visible);
        if (self.layer) {
